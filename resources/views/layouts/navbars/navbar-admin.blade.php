...
<div x-data="{ abrir: false }" class="relative z-10 px-4 md:mt-10 flex items-center justify-between">
    ...
    <div class="hidden md:flex flex-col items-end self-end gap-2 mt-2 md:gap-2">
        <div class="flex gap-4 items-center">
            ...
            <a href="{{ url('/') }}" class="animation-scale"><svg width="20" class="svg-home-navbar" height="20" viewBox="0 0 42 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{ route('salir') }}" class="button-primary-auto cursor-pointer md:text-base">Cerrar sesión</a>
        </div>
    </div>

    <!-- Menú móvil -->
    @include('layouts.navbars.navbars-menu.navbars-menu-admin.navbar-menu-movil-admin')
</div>
