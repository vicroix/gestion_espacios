    ...
    <section class="form-registro m-20 flex justify-center">
        <div class="flex items-center w-full max-w-[1200px]">
            ...
            <form id="formRegistro" action="{{ route('registro') }}" method="POST">
                @csrf
                <div class="flex flex-col md:ml-[50px] md:w-[600px] gap-5">
                    @if (session('success'))
                    ...
                    @endif
                    <div class="ml-[35px]">
                        <input class="inputs-text border border-gray-300" type="text" name="nombre" id="nombre" placeholder="Nombre*" required>
                    </div>
                    <div class="ml-[35px]">
                        <input class="inputs-text border border-gray-300" type="text" name="apellidos" id="apellidos" placeholder="Apellidos*"
                            required>
                    </div>
                    <div class="flex items-center">
                        ...
                        <input class="inputs-text border border-gray-300" type="text" name="usuario" id="usuario" placeholder="Usuario*" required>
                    </div>
                    <div class="flex items-center">
                        <!--Icono password-->
                        ...
                        <input class="inputs-text border border-gray-300" type="password" name="password" id="password" placeholder="Contraseña*"
                            required>
                    </div>
                    <div class="flex items-center">
                        <!--Icono email-->
                        ...
                        <input class="inputs-text border border-gray-300" type="email" name="email" id="email" placeholder="Correo electrónico*"
                            required>
                    </div>
                    <div class="flex items-center">
                        <!--Icono telefono-->
                        ...
                        <input class="inputs-text border border-gray-300" type="text" name="telefono" id="telefono" placeholder="Teléfono" maxlength="9">
                    </div>

                    <p>*Campo obligatorio</p>
                    <!--Mensaje de contraseña erronea o no-->
            ...
            <div class="flex items-center relative">
                <img src="img/FOCO.jpg" width="437" class="ml-[100]">
            </div>
