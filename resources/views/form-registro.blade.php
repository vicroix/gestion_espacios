        ...
        <div class="flex items-center w-full max-w-[1200px]">
            ...
            <form id="formRegistro" action="{{ route('registro') }}" method="POST">
                ...
                <div class="flex flex-col md:ml-[50px] md:w-[600px] gap-5">
                    ...
                    @endif
                    <div class="ml-[35px]">
                        <input class="inputs-text" type="text" name="nombre" id="nombre" placeholder="Nombre*" required>
                    </div>
                    <div class="ml-[35px]">
                        <input class="inputs-text" type="text" name="apellidos" id="apellidos" placeholder="Apellidos*"
                            required>
                    </div>
                    <div class="flex items-center">
                        ...
                        <input class="inputs-text" type="text" name="usuario" id="usuario" placeholder="Usuario*" required>
                    </div>
                    <div class="flex items-center">
                        <!--Icono password-->
                        ...
                        <input class="inputs-text" type="password" name="password" id="password" placeholder="Contraseña*"
                            required>
                    </div>
                    <div class="flex items-center">
                        <!--Icono email-->
