...
<div class="flex flex-col w-full p-10 h-full items-center fondo-editar-reservas">
    <div class="flex flex-col md:w-[600px] md:h-[300px] w-[300px] sm:w-[500px] sm:h-[300px] bg-[--color-transparencia-cartas] p-4 border-t-4 border-[--color-primario] rounded-md backdrop-blur-sm items-center gap-4 mt-12 lg:gap-8">
        <div class="flex justify-center">
            <div class="text-stroke sm:border-b sm:border-[#808080] items-center sm:w-[450px] flex justify-center">
                <h3 class="text-center flex text-xl md:text-2xl">Editar: {{ $reserva->nombre }}</h3>
            </div>
        </div>
