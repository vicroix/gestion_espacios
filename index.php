...
<body>
    ...
    <footer>
        <div class="w-full mx-auto relative">
            <div class="contenedor-contacto-redes-footer flex justify-between items-center h-full">
                ...
                <div class="contenedor-redes space-y-3">
                    ...
                    <div class="contenedor-svg flex gap-[8px]">
                        <a href="" class="animation-scale svg-redes"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="text-[#990000]">
            ...
            <!-- Logo central footer -->
            <div class="contenedor-logo-footer absolute left-1/2 transform -translate-x-1/2 bottom-[2px]">
                <img src="img/deco-footer.png" alt="footer-icon" class="min-w-8 h-[35px]">
            </div>
        </div>
    </footer>
</body>
