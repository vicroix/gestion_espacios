    ...
    <div class="hidden md:flex flex-col items-end gap-2 self-end mt-2">
        ...
        <div class="flex gap-4 items-center">
            ...
            <div class="flex gap-3 border-2 border-[#990000] rounded-xl relative">
                ...
                <a href="<?php echo e(url('proximos-eventos')); ?>" class="hover:bg-[#990000] border border-white hover:text-white rounded-xl p-2 transition-all duration-300 ease-out">
                    Próximos eventos
                </a>
                <a href="<?php echo e(url('faq')); ?>" class="hover:bg-[#990000] border border-white hover:text-white rounded-xl p-2 transition-all duration-300 ease-out">
                    FAQ
                </a>
            </div>

            <a href="<?php echo e(route('salir')); ?>" class="bg-[#990000] hover:bg-[#a84848] text-white px-2 py-2.5 rounded-lg cursor-pointer">
                Cerrar sesión
            </a>
        </div>
    </div>
