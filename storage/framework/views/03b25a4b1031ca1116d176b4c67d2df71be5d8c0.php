...
<main class="flex-grow flex flex-col items-center bg-white">
    ...
    <div class="flex gap-2">
        <form class="w-full max-w-3xl flex flex-col justify-center p-6" method="GET">
        ...
        <div class="h-[80%] justify-center items-center align-center p-6">
            <form method="GET" class="border rounded-xl flex flex-col gap-1 m-0 items-center" action="<?php echo e(route('buscar-sala')); ?>">
                <?php echo csrf_field(); ?>
