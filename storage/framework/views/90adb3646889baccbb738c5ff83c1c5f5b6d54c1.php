...
<main class="m-4">
    ...
    <section class="flex items-start justify-center gap-9">
        ...
        <div class="flex flex-col gap-6">
            <form action="<?php echo e(route('reservar')); ?>" method="POST" class="flex flex-col gap-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex gap-4 items-center">
                    <div>
                        <a href="<?php echo e(route('buscar-sala',['id'=> $espacio->idespacios] )); ?>" class="inline-flex items-center  button-secundary-auto">
    ...
    <?php else: ?>
    <p>No seleccionaste un espacio en busqueda de salas: <a href="<?php echo e(url('buscar-sala')); ?>" class="hover:text-[#990000] font-semibold">nuevas reservas</a></p>
    <?php endif; ?>
